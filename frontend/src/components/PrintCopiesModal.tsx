      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4">
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          <button
            onClick={onDecrement}
            disabled={copies <= 1}
            className="w-16 h-16 rounded-full bg-gradient-green text-white flex items-center justify-center text-3xl font-bold hover:scale-110 transition-transform disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
